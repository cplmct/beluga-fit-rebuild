...
const GUIDANCE_COPY: Record<string, GuidanceCopy> = {
  ...
  'Pike Push-ups': ['Start in a pike with hands under shoulders, hips high, and heels lifted as needed.', 'Bend your elbows to lower the crown of your head toward the floor between your hands.', 'Finish in the lowered pike position with elbows bent, hips high, and head close to the floor between the hands.', ['Keep your elbows angled back rather than flaring wide.', 'Walk your feet closer to increase shoulder loading gradually.']],
  ...
  'Diamond Push-ups': ['Set your hands close under the sternum with thumbs and index fingers forming a diamond.', 'Lower your chest toward your hands while keeping elbows close to your ribs.', 'Finish near the bottom with chest over the hands, elbows bent close to the ribs, and body held in one line.', ['Brace your abdomen before every rep.', 'Widen the hand position slightly if your wrists need less strain.']],
  ...
  'Rear Delt Fly': ['Sit near the edge of a bench, hinge forward with a flat back, and hold dumbbells below the thighs.', 'Sweep the weights outward by moving the upper arms while keeping the seated torso fixed.', 'Finish seated with the dumbbells wide near shoulder level, elbows softly bent, and chest angled forward.', ['Use a light load and keep elbows softly bent.', 'Avoid turning the movement into a row.']],
  ...
  'Close-grip Bench Press': ['Lie on the bench with hands narrower than a standard press and the bar over the chest.', 'Lower the bar toward the lower chest with elbows tracking close to your sides.', 'Finish with the bar over the chest, arms extended, wrists stacked, and shoulder blades set.', ['Do not make the grip so narrow that wrists bend sharply.', 'Keep feet planted during the press.']],
  ...
  'Overhead Tricep Extension': ['Hold one dumbbell overhead with both hands and elbows pointing forward.', 'Lower the dumbbell behind your head by bending the elbows while keeping upper arms still.', 'Finish with the dumbbell behind the head, elbows bent and pointing upward, and ribs held down.', ['Use a stance that lets you brace comfortably.', 'Keep the elbows pointing toward the ceiling.']],
  'Skull Crushers': ['Lie on a bench holding the bar above the chest with arms extended and elbows fixed.', 'Bend the elbows to lower the bar toward the forehead or just behind it.', 'Finish with the bar controlled near the forehead, elbows bent, and upper arms held steady.', ['Use a spotter or safety pins for a heavy set.', 'Move only at the elbows and keep wrists neutral.']],
  ...
  'Squat': ['Place the bar on your upper back with feet about shoulder width and toes slightly out.', 'Sit down and back with knees tracking over toes while the chest stays lifted.', 'Finish at controlled squat depth with the bar over mid-foot, knees tracking over toes, and torso braced.', ['Brace before descending and breathe out through the sticking point.', 'Keep knees from collapsing inward.']],
  'Pause Squat': ['Set up for a barbell squat with a braced torso and balanced foot pressure.', 'Descend under control, pause at your chosen depth without relaxing, then maintain knee tracking.', 'Finish in a tight paused squat with the bar over mid-foot, knees aligned, and torso braced.', ['Use a lighter load than a regular squat.', 'Stay tight during the pause instead of resting on your joints.']],
  'Front Squat': ['Rest the bar across the front shoulders with elbows high and feet about shoulder width.', 'Squat between the hips while keeping elbows lifted and torso upright.', 'Finish at controlled squat depth with elbows high, knees tracking over toes, and the bar supported across the shoulders.', ['Keep the bar supported by the shoulders, not your hands.', 'Brace hard to prevent the chest from folding forward.']],
  ...
  'Romanian Deadlift': ['Stand with a bar at the thighs, knees softly bent, and shoulders pulled down.', 'Push the hips back while the bar slides close down the legs and the back stays flat.', 'Finish in the hinge with the bar close below the knees, hips back, knees softly bent, and spine neutral.', ['Keep the bar near your body.', 'Do not chase depth by rounding your lower back.']],
  'Lunges': ['Stand tall with dumbbells at your sides and feet together, chest lifted.', 'Step forward and lower the back knee toward the floor while the front shin stays controlled.', 'Finish at the bottom of the lunge with both knees bent, front foot planted, and torso upright.', ['Keep the front knee tracking over the second toe.', 'Use a stride that lets the torso stay upright.']],
  ...
  'Calf Raises': ['Stand tall with feet about hip width, toes pointing forward, and arms relaxed by your sides.', 'Press through the balls of the feet to raise both heels while keeping the legs straight and torso upright.', 'Finish balanced on the balls of the feet with heels raised, ankles aligned, and body tall.', ['Keep ankles traveling straight rather than rolling out.', 'Pause at both the bottom and the top.']],
  ...
  'Kettlebell Goblet Squat': ['Hold the kettlebell by its horns at chest height with feet shoulder width and toes slightly out.', 'Sit between your hips while keeping the bell close and elbows tracking inside the knees.', 'Finish at controlled squat depth with the kettlebell at the chest, knees tracking over toes, and torso upright.', ['Keep your knees aligned with your toes.', 'Brace your trunk so the bell does not pull you forward.']],
  ...
  'Pistol Squat': ['Balance on one leg with the other leg extended forward and arms reaching for counterbalance.', 'Sit down on the standing leg while keeping the extended leg and heel lifted.', 'Finish at the bottom on one leg with the free leg extended forward, heel lifted, and standing knee aligned over the foot.', ['Use a box or support for a controlled progression.', 'Move only as deep as you can keep the foot grounded.']],
  ...
  'Jumping Jacks': ['Stand with feet together and arms by your sides, knees softly bent.', 'Jump feet apart while sweeping arms overhead in one coordinated movement.', 'Finish with feet wider than the hips, arms overhead, and knees softly bent for the landing.', ['Land quietly with knees relaxed.', 'Use a step-out version if jumping is not appropriate.']],
  ...
  'Kettlebell Windmill': ['Stand wide with one kettlebell overhead and toes turned slightly away from the loaded side.', 'Push the hip toward the unloaded side and hinge down while keeping the bell stacked overhead.', 'Finish in the side hinge with the loaded arm vertical, chest rotated toward the bell, and spine long.', ['Rotate the chest toward the bell.', 'Use a shallow range until hamstring and shoulder control are secure.']],
  'Kettlebell Russian Twist': ['Sit with knees bent and hold a kettlebell close to the chest while leaning back slightly.', 'Rotate the torso side to side, guiding the bell across the body without collapsing the spine.', 'Finish rotated to one side with the kettlebell close to the hip, chest lifted, and spine long.', ['Keep the hips grounded and feet stable.', 'Use a slow range instead of swinging the kettlebell.']],
  "Kettlebell Farmer's Carry": ['Stand tall holding a kettlebell in each hand with shoulders level and arms long.', 'Walk with short, controlled steps while keeping the torso upright and the bells quiet.', 'Finish tall with both kettlebells beside the thighs, shoulders level, and arms long.', ['Brace as if preparing for contact.', 'Keep the shoulders away from the ears.']],
  ...
  'Dragon Flag': ['Lie on a bench holding its edge behind the head with hips and knees bent toward the torso.', 'Extend the hips and legs upward as one braced unit while keeping the shoulders anchored to the bench.', 'Finish with the body raised in a straight line from shoulders through feet without swinging the legs.', ['Use a bent-knee progression first.', 'Stop before the lower back arches.']],
  'Hollow Body Hold': ['Lie on your back with shoulders lifted, knees tucked toward the chest, and lower back pressed toward the floor.', 'Extend the arms and legs away from the torso while maintaining the hollow curve and steady breathing.', 'Finish in a long hollow hold with arms overhead, legs extended, and lower back pressed toward the floor.', ['Shorten the lever by bending the knees when needed.', 'Keep ribs tucked toward the pelvis.']],
  ...
  'Bear Crawl': ['Start on hands and knees with hands under shoulders, knees under hips, and back flat.', 'Lift the knees just above the floor, then step the opposite hand and foot forward while keeping the hips low.', 'Finish in a controlled crawl stance with knees hovering, back flat, and opposite hand and foot advanced.', ['Keep knees close to the floor.', 'Move quietly so the hips do not sway side to side.']],
  'Inchworm': ['Stand with hips hinged, hands on the floor, and legs as straight as comfortable.', 'Walk the hands forward while the hips and ribs stay controlled.', 'Finish in a high plank with shoulders over the hands, legs long, and body braced.', ['Bend the knees slightly rather than rounding aggressively.', 'Keep shoulders over the hands in the plank.']],
  'Burpee Pull-up': ['Stand beneath a secure pull-up bar with enough clearance to jump safely.', 'Drop to a plank, bring the feet forward, jump to the bar, and pull the chest toward it.', 'Finish at the top with chin above the bar, elbows bent, and body controlled beneath the grip.', ['Use a step-back or assisted pull-up progression.', 'Keep the bar and landing area clear.']],
};

/*
 * Reviewed exact-equivalent filename mappings:
 * - Ab Wheel uses the ab-wheel-rollout pair: the artwork depicts a kneeling ab-wheel rollout.
 * - Dumbbell Press uses the dumbbell-bench-press pair: the catalog exercise is a flat dumbbell press.
 * - Chest Fly uses the dumbbell-chest-fly pair: the catalog equipment is Dumbbell.
 * - Chin-ups, Face Pulls, Hyperextensions, Lateral Raises, and Tuck Jump use
 *   singular/plural filename variants of the same movement.
 * - Front Raises and Shrugs use dumbbell-qualified files matching their catalog equipment.
 * - Rear Delt Fly uses the seated rear-delt-fly pair, with copy aligned to that seated variation.
 * - Front Squat uses the barbell-qualified pair matching its catalog equipment.
 *
 * Previously approved semantic mappings for Bench Press, Overhead Press, Squat,
 * and Lunges remain documented by their exact entries below. No Military Press,
 * Archer Push-up, dumbbell Upright Row, machine Calf Raise, or dumbbell Goblet
...
const IMAGE_SOURCES: Record<string, { start?: ImageSourcePropType; finish?: ImageSourcePropType }> = {
  ...
  'Calf Raises': { start: require('../../assets/guidance/calf-raises-start.webp'), finish: require('../../assets/guidance/calf-raises-finish.webp') },
  ...
  'Jump Squat': { start: require('../../assets/guidance/jump-squat-start.webp') },
  ...
  'Tuck Jump': { start: require('../../assets/guidance/tuck-jumps-start.webp') },
  ...
  'Jumping Jacks': { start: require('../../assets/guidance/jumping-jacks-start.webp'), finish: require('../../assets/guidance/jumping-jacks-finish.webp') },
  'Burpees': { start: require('../../assets/guidance/burpees-start.webp'), finish: require('../../assets/guidance/burpees-finish.webp') },
  ...
  'Kettlebell Turkish Get-Up': { start: require('../../assets/guidance/kettlebell-turkish-get-up-start.webp'), finish: require('../../assets/guidance/kettlebell-turkish-get-up-finish.webp') },
  'Kettlebell Windmill': { start: require('../../assets/guidance/kettlebell-windmill-start.webp'), finish: require('../../assets/guidance/kettlebell-windmill-finish.webp') },
  'Kettlebell Russian Twist': { start: require('../../assets/guidance/kettlebell-russian-twist-start.webp'), finish: require('../../assets/guidance/kettlebell-russian-twist-finish.webp') },
  "Kettlebell Farmer's Carry": { start: require('../../assets/guidance/kettlebell-farmers-carry-start.webp'), finish: require('../../assets/guidance/kettlebell-farmers-carry-finish.webp') },
  'Kettlebell Around the World': { start: require('../../assets/guidance/kettlebell-around-the-world-start.webp'), finish: require('../../assets/guidance/kettlebell-around-the-world-finish.webp') },
  'L-Sit': { start: require('../../assets/guidance/l-sit-start.webp'), finish: require('../../assets/guidance/l-sit-finish.webp') },
  'Dragon Flag': { start: require('../../assets/guidance/dragon-flag-start.webp'), finish: require('../../assets/guidance/dragon-flag-finish.webp') },
  'Hollow Body Hold': { start: require('../../assets/guidance/hollow-body-hold-start.webp'), finish: require('../../assets/guidance/hollow-body-hold-finish.webp') },
  'Superman Hold': { start: require('../../assets/guidance/superman-hold-start.webp'), finish: require('../../assets/guidance/superman-hold-finish.webp') },
  'Bear Crawl': { start: require('../../assets/guidance/bear-crawl-start.webp'), finish: require('../../assets/guidance/bear-crawl-finish.webp') },
  'Inchworm': { start: require('../../assets/guidance/inchworm-start.webp'), finish: require('../../assets/guidance/inchworm-finish.webp') },
  'Burpee Pull-up': { start: require('../../assets/guidance/burpee-pull-up-start.webp'), finish: require('../../assets/guidance/burpee-pull-up-finish.webp') },
};
